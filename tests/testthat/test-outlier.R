testthat::test_that("checks function chooseModel",{
  ...
  testthat::expect_equal(chooseModel(dat1, tidyselect::all_of(y),tidyselect::all_of(x))[[1]]$model.name, "linear")
  #testthat::expect_equal(chooseModel(dat1, tidyselect::all_of(y), tidyselect::all_of(x), model)[[1]]$cor, 1)

  testthat::expect_equal(chooseModel(dat2, tidyselect::all_of(y), tidyselect::all_of(x))[[1]]$model.name, "quadratic")
  #testthat::expect_equal(round(chooseModel(dat2, tidyselect::all_of(y), tidyselect::all_of(x), model)[[1]]$cor, 3), 0.962)

  testthat::expect_equal(chooseModel(dat3, tidyselect::all_of(y), tidyselect::all_of(x))[[1]]$model.name, "logistic")
  #testthat::expect_equal(round(chooseModel(dat4, tidyselect::all_of(y), tidyselect::all_of(x), model)[[1]]$cor, 3), 0.992)

  testthat::expect_true(chooseModel(dat4, tidyselect::all_of(y), tidyselect::all_of(x))[[1]]$dat$outlier[4])
  ...
  testthat::expect_equal(sum(chooseModel(dat5, tidyselect::all_of(y), tidyselect::all_of(x), model)[[1]]$dat$outlier), 1)
